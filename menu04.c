...
static menu_item_t * s_menu_add_item  (const char *title, menu_item_callback_t callback);
static menu_item_t * s_create_submenu (const char *title, menu_item_t *parent);
...
void Menu_Init(void)
{
    ...
    menu_item_t *menu_options  = s_menu_add_item("Options", NULL);

    menu_item_t *menu_options_back = s_create_submenu("Back", menu_options);
    menu_item_t *menu_pwm      = s_menu_add_item("PWM",    NULL);
    menu_item_t *menu_lo_arm   = s_menu_add_item("Lo Arm", NULL);
    menu_item_t *menu_hi_arm   = s_menu_add_item("Hi Arm", NULL);

    menu_item_t *menu_pwm_back   = s_create_submenu("Back", menu_pwm);
    menu_item_t *menu_pwm_enable = s_menu_add_item("Enable",    NULL);
    menu_item_t *menu_pwm_freq   = s_menu_add_item("Frequency", NULL);

    menu_item_t *menu_lo_arm_back     = s_create_submenu("Back", menu_lo_arm);
    menu_item_t *menu_lo_arm_enable   = s_menu_add_item("Enable",   NULL);
    menu_item_t *menu_lo_arm_delay    = s_menu_add_item("Delay",    NULL);
    menu_item_t *menu_lo_arm_duration = s_menu_add_item("Duration", NULL);

    menu_item_t *menu_hi_arm_back     = s_create_submenu("Back", menu_hi_arm);
    menu_item_t *menu_hi_arm_enable   = s_menu_add_item("Enable",   NULL);
    menu_item_t *menu_hi_arm_delay    = s_menu_add_item("Delay",    NULL);
    menu_item_t *menu_hi_arm_duration = s_menu_add_item("Duration", NULL);
